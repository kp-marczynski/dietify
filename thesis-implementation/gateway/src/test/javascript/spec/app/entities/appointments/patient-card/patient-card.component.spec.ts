...
import { PatientCardComponent } from 'app/entities/appointments/patient-card/patient-card.component';
...
describe('Component Tests', () => {
  describe('PatientCard Management Component', () => {
    let comp: PatientCardComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PatientCardComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.patientCards[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
