...
describe('ProductCategory e2e test', () => {
  ...
  it('should load ProductCategories', async () => {
    ...
    expect(await productCategoryComponentsPage.getTitle()).to.eq('gatewayApp.productsProductCategory.home.title');
  });
  ...
  it('should load create ProductCategory page', async () => {
    ...
    expect(await productCategoryUpdatePage.getPageTitle()).to.eq('gatewayApp.productsProductCategory.home.createOrEditLabel');
  ...
  it('should create and save ProductCategories', async () => {
    ...
    await productCategoryComponentsPage.clickOnCreateButton();
    await promise.all([productCategoryUpdatePage.setDescriptionInput('description')]);
  ...
  it('should delete last ProductCategory', async () => {
    ...
    expect(await productCategoryDeleteDialog.getDialogTitle()).to.eq('gatewayApp.productsProductCategory.delete.question');
