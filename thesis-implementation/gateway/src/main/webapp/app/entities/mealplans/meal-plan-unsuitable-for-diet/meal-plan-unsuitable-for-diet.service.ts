...
export class MealPlanUnsuitableForDietService {
  public resourceUrl = SERVER_API_URL + 'services/mealplans/api/meal-plan-unsuitable-for-diets';
  public resourceSearchUrl = SERVER_API_URL + 'services/mealplans/api/_search/meal-plan-unsuitable-for-diets';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IMealPlanUnsuitableForDiet[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
