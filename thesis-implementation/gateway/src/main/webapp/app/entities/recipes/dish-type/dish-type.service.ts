...
export class DishTypeService {
  public resourceUrl = SERVER_API_URL + 'services/recipes/api/dish-types';
  public resourceSearchUrl = SERVER_API_URL + 'services/recipes/api/_search/dish-types';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IDishType[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
