...
\pagebreak %todo sprawdzić czy to jest na pewno potrzebne
...
\begin{enumerate}[label={\textbf{KAT/2/\protect\twodigits{\theenumi}}}, wide, labelwidth=!, labelindent=0pt, labelsep=0pt, series=reqs]
    ...
    \begin{itemize}[series=atr, wide, align=left, leftmargin=190pt]
        ...
        \atr{createdDate}\label{kat:Product:createdDate}- czas utworzenia wersji
        \atr{description}\label{kat:Product:description}- krótki opis produktu w~języku produktu
        \atr{source}\label{kat:Product:source}- źródło produktu, jeśli produkt jest importowany; preferowany format adresu URL
        \atr{isFinal}\label{kat:Product:isFinal}- flaga określająca czy produkt jest dostępny do edycji czy jest zablokowany
...
Na rysunku \ref{fig:class-diagram:products} przedstawiono model informacyjny dla poddziedziny produkty w~formie diagramu klas języka UML.
...
\begin{enumerate}[label={\textbf{KAT/3/\protect\twodigits{\theenumi}}}, wide, labelwidth=!, labelindent=0pt, labelsep=0pt, series=reqs]
    ...
    \begin{itemize}[series=atr, wide, align=left, leftmargin=190pt]
        ...
        \atr{editTimestamp}\label{kat:Recipe:editTimestamp}- czas utworzenia wersji
        \atr{name}\label{kat:Recipe:name}- nazwa przepisu w~języku przepisu
        \atr{preparationTimeMinutes}\label{kat:Recipe:preparationTimeMinutes}- średni czas potrzebny na całkowite przygotowanie przepisu, zdefiniowany w~minutach
        \atr{numberOfPortions}\label{kat:Recipe:numberOfPortions}- liczba porcji dla których przepis jest zdefiniowany
        \atr{image}\label{kat:Recipe:image}- opcjonalne zdjęcie dania przygotowanego na podstawie przepisu
        \atr{totalGramsWeight}\label{kat:Recipe:totalGramsWeight}- całkowita masa w~gramach dania przygotowanego z~przepisu
        \atr{isFinal}\label{kat:Recipe:isFinal}- flaga określająca czy przepis jest dostępny do edycji czy jest zablokowany
...
\begin{enumerate}[label={\textbf{KAT/4/\protect\twodigits{\theenumi}}}, wide, labelwidth=!, labelindent=0pt, labelsep=0pt, series=reqs]
    ...
    \begin{itemize}[series=atr, wide, align=left, leftmargin=190pt]
        ...
        \atr{isFinal}\label{kat:MealPlan:isFinal}- flaga określająca czy jadłospis jest edytowalny
