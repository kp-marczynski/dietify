...
przy czym należy również wziąć pod uwagę rejestrację (wysunek \ref{fig:mockup:0home_1sign-up}) i logowanie (rysunek \ref{fig:mockup:0home_2login}) użytkowników do systemu.
