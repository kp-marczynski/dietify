...
\todo{podstawowe mikroserwisy, jeszcze bez opisu netflixa; relacyjna baza danych}
...
%\todo{zmienić układ: sekcja "Model informacyjny", podsekcje dla każdej poddziedziny a w nich odpowiednie kategorie, reguły, ograniczenia i diagram klas}
...
\begin{itemize}[label={\textbf{Reguły dla}}, wide, labelwidth=!, labelindent=0pt]
    ...
    \begin{enumerate}[label={\textbf{REG/1/1/\protect\twodigits{\arabic{enumi}}}}, wide, labelwidth=!, align=left, leftmargin=3cm]
        %Relacje
