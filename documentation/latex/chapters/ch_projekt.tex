...
\todo{zgoda rodo przy rejestracji, informacja o konieczności uzyskania zgody od pacjenta przed wprowadzeniem jego danych do systemu}
...
\begin{enumerate}[label={\textbf{KAT/\protect\threedigits{\theenumi}}}, wide, labelwidth=!, labelindent=0pt, labelsep=0pt, series=reqs]
    ...
    \req{UserExtraInfo}\label{kat:UserExtraInfo} (Dodatkowe Informacje Użytkownika) \inlinetodo{dodać zgodę na przetwarzanie danych; albo lepiej dać checbox przy rejestracji i rejestracja niemożliwa bez zaznaczenia zgody. wtedy bez dodatkowego pola w bazie?}
