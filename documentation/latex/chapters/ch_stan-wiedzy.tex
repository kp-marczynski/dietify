...
Podstawowe wyznaczane wartości to wskaźnik masy ciała (ang. Body Mass Index - BMI), stosunek obwodu talii do obwodu bioder (ang. Waist to Hip Ratio - WHR) oraz ilość tkanki tłuszczowej w organizmie\cite[book:dietetyka-zywienie-zdroweg-i-chorego-czlowieka].
