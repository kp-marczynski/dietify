...
takich jak strony odpowiednich programów, blogi internetowe, filmy promocyjne na platformie YouTube\cite{url:youtube}. \inlinetodo{sprawdzić czy korzystanie ze screenshotów z youtube'a jest legalne}
...
\todo{sprawdzić czy aplikacje na pewno nie pozwalają na pracę offline}
\begin{minipage}{\textwidth}
    \begin{table}[H]
...
Aby obliczyć wartość energetyczną posiłku należy wyznaczyć ekwiwalent energetyczny podstawowych wartości odżywczych,
tj. białek, tłuszczy i węglowodanów\cite{book:dietetyka-zywienie-zdroweg-i-chorego-czlowieka}.
...
które również powinny być uwzględnione podczas układania zbilansowanej diety\cite{book:dietetyka-zywienie-zdroweg-i-chorego-czlowieka}.
...
Na rynku polskim tabele takie są odpłatnie udostępniane przez polski Instytut Żywności i Żywienia\cite{book:tabele-wartosci-odzywczych},
...
\par
Podobne rozwiązanie w języku angielskim oferuje Departament Rolnictwa Stanów Zjednoczonych udostępniając całkowicie za darmo
do dowolnego użytku narodową bazę danych wartości odżywczych dla standardowych odwołań (ang. National Nutrient Database for Standard Reference)\cite{url:usda-sr-db}.
