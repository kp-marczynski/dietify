...
\begin{listing}[h!]
    ...
    \end{minted}
    \centering\caption{Uruchamianie Gradle Wrapper (źródło: \ownwork)}\label{listing:javadoc}
\end{listing}
...
\begin{listing}[h!]
    ...
    \end{minted}
    \centering\caption{Skrypt kompilujący wszystkie mikroserwisy i~uruchamiający aplikację na Dockerze (źródło: \ownwork)}\label{listing:komilacja-i-uruchomienie}
\end{listing}
...
\begin{listing}[h!]
    ...
    \end{minted}
    \centering\caption{Uruchamianie JHipster Registry (źródło: \ownwork)}\label{listing:service-discovery}
\end{listing}
...
\begin{listing}[h!]
    \begin{minted}{bash}
        ./gradlew
    \end{minted}
    \centering\caption{Uruchamianie Gradle Wrapper (źródło: \ownwork)}\label{listing:run-gradle-wrapper}
\end{listing}
