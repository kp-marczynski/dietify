...
\imagewide{img/interface/0home.jpg}{Widok~- todo}{interface:0home}
...
\image{0.5}{img/interface/0mobile.jpg}{Widok~- todo}{interface:0mobile}
...
\imagewide{img/interface/0admin.jpg}{Widok~- todo}{interface:0admin}
...
\imagewide{img/interface/0admin2.jpg}{Widok~- todo}{interface:0admin2}
...
\imagewide{img/interface/0admin3.jpg}{Widok~- todo}{interface:0admin3}
...
\imagewide{img/interface/0sign-in.jpg}{Widok~- todo}{interface:0sign-in}
...
\imagewide{img/interface/1products2.jpg}{Widok~- todo}{interface:1products2}
...
\imagewide{img/interface/1products-edit.png}{Widok~- todo}{interface:1products-edit}

\imagewide{img/interface/1products-edit2.jpg}{Widok~- todo}{interface:1products-edit2}

\imagewide{img/interface/1products-edit3.jpg}{Widok~- todo}{interface:1products-edit3}
...
\imagewide{img/interface/1products-details.jpg}{Widok~- todo}{interface:1products-details}
...
\imagewide{img/interface/2recipes.jpg}{Widok~- todo}{interface:2recipes}
...
\imagewide{img/interface/2recipe-edit.jpg}{Widok~- todo}{interface:2recipe-edit}

\imagewide{img/interface/2recipe-edit2.jpg}{Widok~- todo}{interface:2recipe-edit2}
...
\imagewide{img/interface/2recipe-details.jpg}{Widok~- todo}{interface:2recipe-details}
...
\imagewide{img/interface/3mealplans.jpg}{Widok~- todo}{interface:3mealplans}

Na rysunku \ref{interface:3mealplan-edit1} przedstawiono widok zakładki ustawień podczas edycji jadłospisu odpowiadający prototypowi z rysunku \ref{fig:mockup:3mealplans_1new_1settings}.

\imagewide{img/interface/3mealplan-edit1.jpg}{Widok~- todo}{interface:3mealplan-edit1}

Na rysunku \ref{interface:3mealplan-edit2} przedstawiono widok zakładki kalendarza podczas edycji jadłospisu \ref{fig:mockup:3mealplans_1new_2calendar}.

\imagewide{img/interface/3mealplan-edit2.jpg}{Widok~- todo}{interface:3mealplan-edit2}
...
\imagewide{img/interface/4patients.jpg}{Widok~- todo}{interface:4patients}
...
\imagewide{img/interface/4patient-card.jpg}{Widok~- todo}{interface:4patient-card}
...
\imagewide{img/interface/4appointment-details.jpg}{Widok~- todo}{interface:4appointment-details}
...
\imagewide{img/interface/4nutritional-interview.jpg}{Widok~- todo}{interface:4nutritional-interview}
