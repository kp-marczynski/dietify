...
\begin{itemize}[series=atr, wide, align=left, leftmargin=190pt]
    ...
    \atr{Zarządzanie dietą}- wspomaganie procesu tworzenia odpowiednio zbilansowanego jadłospisu i~kontrola rezultatów stosowania stworzonego jadłospisu
\end{itemize}
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        ...
        \begin{tabular}{|P{.2\textwidth}|P{.7\textwidth}|}
            ...
            \hline
            \cellgray{Problem} &
            \multicolumn{1}{|l|}{Problem z~ręcznym układaniem jadłospisu i kontrolą rezultatów stosowania jadłospisu przez pacjenta}\\
            \hline
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        ...
        \begin{tabular}{|P{.2\textwidth}|P{.7\textwidth}|}
            ...
            \multicolumn{1}{|l|}{Aplikacja webowa wspomagająca pracę dietetyka "Dietify"} \\
            \hline
            ...
            \multicolumn{1}{|l|}{Skupia się na tworzeniu i~udostępnianiu jadłospisów oraz kontroli rezultatów ich stosowania} \\
            \hline
        \end{tabular}
    \end{table}
\end{minipage}
...
\begin{itemize}
    ...
    \item \textbf{poddziedzina przepisy}~- pozwalająca na tworzenie i~zarządzanie przepisami, w~tym przypisywanie do przepisów produktów
    \item \textbf{poddziedzina jadłospisy}~- pozwalająca na tworzenie i~zarządzanie jadłospisami, w~tym przypisywanie do jadłospisów produktów i~przepisów
