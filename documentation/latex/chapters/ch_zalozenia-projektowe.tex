...
Na podstawie rozważań z~rozdziału \ref{ch:knowladge-state} sporządzono następującą listę definicji domenowych istotną z~punkty widzenia projektu:
\begin{itemize}[series=atr, wide, align=left, leftmargin=190pt]
    ...
    \atr{Dieta}- sposób odżywiania uwzględniający potrzeby organizmu, ze zdefiniowaną ilością i~jakością pożywienia
    ...
    \atr{MET}- ekwiwalent metaboliczny
    ...
    \atr{Podstawowe wartości odżywcze}- energia, białko, tłuszcz, węglowodany
    ...
    \atr{PPM}- podstawowa przemiana materii
    ...
    \atr{Baza USDA}- baza produktów udostępniana przez Departament Rolnictwa Stanów Zjednoczonych
    ...
    \atr{Zarządzanie dietą}- wspomaganie procesu układania odpowiednio zbilansowanego jadłospisu i~kontrola rezultatów stosowania ułożonego jadłospisu
\end{itemize}
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Sformułowanie problemu (źródło: \ownwork)\label{tabela:sformulowanie-problemu}}
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Pozycjonowanie produktu (źródło: \ownwork)\label{tabela:pozycjonowanie-produktu}}
        \begin{tabular}{|P{.2\textwidth}|p{.7\textwidth}|}
            ...
            \cellgray{Który} &
            Chce łatwiej zarządzać dietą \\
            \hline

            \cellgray{Nazwa produktu} &
            Aplikacja webowa wspomagająca pracę dietetyka "Dietify" \\
            \hline

            \cellgray{Który} &
            Skraca czas potrzebny na ułożenie i~zarządzanie jadłospisami \\
            \hline
            ...
            Skupia się na układaniu i~udostępnianiu jadłospisów oraz kontroli rezultatów ich stosowania \\
            \hline
        \end{tabular}
    \end{table}
\end{minipage}
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Użytkownicy (źródło: \ownwork)\label{tabela:uzytkownicy}}
        \begin{tabular}{|P{.15\textwidth}|P{.25\textwidth}|P{.5\textwidth}|}
            ...
            \begin{itemize}
                ...
                \item Zarządza wizytami pacjenta.
            \end{itemize} \\
            \hline
            Administrator &
...
Na rysunku \ref{fig:use-case-diagram:users} przedstawiono relacje pomiędzy użytkownikami korzystając z~notacji diagramu przypadków użycia języka UML.
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Wymagania funkcjonalne~- poddziedzina administracyjna (źródło: \ownwork)\label{tabela:wymaganiaFunkcjonalneOgolne}}
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Wymagania funkcjonalne~- poddziedzina produkty (źródło: \ownwork)\label{tabela:wymaganiaFunkcjonalneProdukty}}
        \begin{tabular}{|P{.3\textwidth}|P{.6\textwidth}|}
            \hline
            \cellgray{Potrzeby} & \cellgray{Cechy} \\
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Wymagania funkcjonalne~- poddziedzina przepisy (źródło: \ownwork)\label{tabela:wymaganiaFunkcjonalnePrzepisy}}
        \begin{tabular}{|P{.3\textwidth}|P{.6\textwidth}|}
            \hline
            \cellgray{Potrzeby} & \cellgray{Cechy} \\
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Wymagania funkcjonalne~- poddziedzina jadłospisy (źródło: \ownwork)\label{tabela:wymaganiaFunkcjonalneJadlospisy}}
        \begin{tabular}{|P{.3\textwidth}|P{.6\textwidth}|}
            \hline
            \cellgray{Potrzeby} & \cellgray{Cechy} \\
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        \centering\caption{Wymagania funkcjonalne~- poddziedzina wizyty (źródło: \ownwork)\label{tabela:wymaganiaFunkcjonalneWizyty}}
        \begin{tabular}{|P{.3\textwidth}|P{.6\textwidth}|}
            \hline
            \cellgray{Potrzeby} & \cellgray{Cechy} \\
