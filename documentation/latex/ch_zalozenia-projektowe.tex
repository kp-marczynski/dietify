...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        ...
        \begin{tabular}{|P{.2\textwidth}|P{.7\textwidth}|}
            ...
            \hline
            \cellcolor[HTML]{DDDDDD}Problem &
            \multicolumn{1}{|l|}{Problem z~ręcznym ukladaniem jadłospisu}\\
            \hline

            \cellcolor[HTML]{DDDDDD}Dotyczy &
            \multicolumn{1}{|l|}{Dietetyków}\\
            \hline

            \cellcolor[HTML]{DDDDDD}Wpływ problemu &
            \begin{itemize}
            ...
            \cellcolor[HTML]{DDDDDD}Pomyślne rozwiązanie &
            \begin{itemize}
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        ...
        \begin{tabular}{|P{.2\textwidth}|P{.7\textwidth}|}
            ...
            \hline
            \cellcolor[HTML]{DDDDDD}Dla &
            \multicolumn{1}{|l|}{Dietetyka}\\
            \hline

            \cellcolor[HTML]{DDDDDD}Który &
            \multicolumn{1}{|l|}{Chce łatwiej zarządzać tworzeniem jadłospisu}\\
            \hline

            \cellcolor[HTML]{DDDDDD}Nazwa produktu &
            ...
            \cellcolor[HTML]{DDDDDD}Inaczej niż &
            \multicolumn{1}{|l|}{Kalkulator kalorii} \\
            \hline

            \cellcolor[HTML]{DDDDDD}Nasz produkt &
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        ...
        \begin{tabular}{|P{.15\textwidth}|P{.25\textwidth}|P{.5\textwidth}|}
            ...
            \hline
            \cellcolor[HTML]{DDDDDD}Nazwa & \cellcolor[HTML]{DDDDDD}Opis & \cellcolor[HTML]{DDDDDD}Odpowiedzialności\\
...
\begin{minipage}{\textwidth}
    \begin{table}[H]
        ...
        \begin{tabular}{|P{.3\textwidth}|P{.6\textwidth}|}
            \hline
            \cellcolor[HTML]{DDDDDD}Potrzeby & \cellcolor[HTML]{DDDDDD}Cechy \\
