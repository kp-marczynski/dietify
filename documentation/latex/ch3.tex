...
\begin{enumerate}[label={\textbf{KAT/\protect\threedigits{\theenumi}}}, wide, labelwidth=!, labelindent=0pt, labelsep=0pt, series=reqs]
    ...
    Opis: Dodatkowe informacje o użytkowniku
    \par
    Atrybuty:
    \begin{itemize}[series=atr, wide, align=left, leftmargin=5cm]
    ...
    Opis: Treść strony definiowana przez administratora
    \par
    Atrybuty:
    \begin{itemize}[series=atr, wide, align=left, leftmargin=5cm]
    ...
    Opis: Tłumaczenie treści strony
    \par
    Atrybuty:
    \begin{itemize}[series=atr, wide, align=left, leftmargin=5cm]
    ...
    Opis: Informacje kontaktowe witryny
    \par
    Atrybuty:
    \begin{itemize}[series=atr, wide, align=left, leftmargin=5cm]
    ...
    Opis: Pozycja cennika dostępu do usług oferowanych przez system
    \par
    Atrybuty:
    \begin{itemize}[series=atr, wide, align=left, leftmargin=5cm]
    ...
    Opis: Tłumaczenie pozycji cennika
    \par
    Atrybuty:
    \begin{itemize}[series=atr, wide, align=left, leftmargin=5cm]
