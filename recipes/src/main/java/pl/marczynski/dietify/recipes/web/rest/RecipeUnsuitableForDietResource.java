...
public class RecipeUnsuitableForDietResource {
     ...
     *
     * @param recipeUnsuitableForDietDTO the recipeUnsuitableForDietDTO to create.
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new recipeUnsuitableForDietDTO, or with status {@code 400 (Bad Request)} if the recipeUnsuitableForDiet has already an ID.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PostMapping("/recipe-unsuitable-for-diets")
    public ResponseEntity<RecipeUnsuitableForDietDTO> createRecipeUnsuitableForDiet(@Valid @RequestBody RecipeUnsuitableForDietDTO recipeUnsuitableForDietDTO) throws URISyntaxException {
        log.debug("REST request to save RecipeUnsuitableForDiet : {}", recipeUnsuitableForDietDTO);
        if (recipeUnsuitableForDietDTO.getId() != null) {
            throw new BadRequestAlertException("A new recipeUnsuitableForDiet cannot already have an ID", ENTITY_NAME, "idexists");
        }
        RecipeUnsuitableForDietDTO result = recipeUnsuitableForDietService.save(recipeUnsuitableForDietDTO);
     ...
     *
     * @param recipeUnsuitableForDietDTO the recipeUnsuitableForDietDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated recipeUnsuitableForDietDTO,
     * or with status {@code 400 (Bad Request)} if the recipeUnsuitableForDietDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the recipeUnsuitableForDietDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/recipe-unsuitable-for-diets")
    public ResponseEntity<RecipeUnsuitableForDietDTO> updateRecipeUnsuitableForDiet(@Valid @RequestBody RecipeUnsuitableForDietDTO recipeUnsuitableForDietDTO) throws URISyntaxException {
        log.debug("REST request to update RecipeUnsuitableForDiet : {}", recipeUnsuitableForDietDTO);
        if (recipeUnsuitableForDietDTO.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
        RecipeUnsuitableForDietDTO result = recipeUnsuitableForDietService.save(recipeUnsuitableForDietDTO);
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, recipeUnsuitableForDietDTO.getId().toString()))
            .body(result);
    }
    ...
    public List<RecipeUnsuitableForDietDTO> getAllRecipeUnsuitableForDiets() {
     ...
     *
     * @param id the id of the recipeUnsuitableForDietDTO to retrieve.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the recipeUnsuitableForDietDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/recipe-unsuitable-for-diets/{id}")
    public ResponseEntity<RecipeUnsuitableForDietDTO> getRecipeUnsuitableForDiet(@PathVariable Long id) {
        log.debug("REST request to get RecipeUnsuitableForDiet : {}", id);
        Optional<RecipeUnsuitableForDietDTO> recipeUnsuitableForDietDTO = recipeUnsuitableForDietService.findOne(id);
        return ResponseUtil.wrapOrNotFound(recipeUnsuitableForDietDTO);
    }

    /**
     * {@code DELETE  /recipe-unsuitable-for-diets/:id} : delete the "id" recipeUnsuitableForDiet.
     *
     * @param id the id of the recipeUnsuitableForDietDTO to delete.
    ...
    public List<RecipeUnsuitableForDietDTO> searchRecipeUnsuitableForDiets(@RequestParam String query) {
