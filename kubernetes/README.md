...
```
$ docker image tag gateway dietify/gateway
$ docker push dietify/gateway
$ docker image tag products dietify/products
$ docker push dietify/products
$ docker image tag recipes dietify/recipes
$ docker push dietify/recipes
$ docker image tag mealplans dietify/mealplans
$ docker push dietify/mealplans
$ docker image tag appointments dietify/appointments
$ docker push dietify/appointments
```
...
```
$ kubectl get svc gateway -n dietify
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n dietify
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n dietify
```
...
```
$ kubectl get svc jhipster-console -n dietify
```
...
```
$ kubectl expose service jhipster-registry --type=NodePort --name=exposed-registry -n dietify
```

and explore the details using

```
$ kubectl get svc exposed-registry -n dietify
```

For scaling the JHipster registry, use

```
$ kubectl scale statefulset jhipster-registry --replicas 3 -n dietify
```
