...
export class ProductCategoryService {
  public resourceUrl = SERVER_API_URL + 'services/products/api/product-categories';
  public resourceSearchUrl = SERVER_API_URL + 'services/products/api/_search/product-categories';
