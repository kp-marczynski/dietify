...
export class NutritionDataService {
  public resourceUrl = SERVER_API_URL + 'services/products/api/nutrition-data';
  public resourceSearchUrl = SERVER_API_URL + 'services/products/api/_search/nutrition-data';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<INutritionData[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
