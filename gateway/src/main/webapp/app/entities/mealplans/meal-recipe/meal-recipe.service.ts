...
export class MealRecipeService {
  public resourceUrl = SERVER_API_URL + 'services/mealplans/api/meal-recipes';
  public resourceSearchUrl = SERVER_API_URL + 'services/mealplans/api/_search/meal-recipes';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IMealRecipe[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
