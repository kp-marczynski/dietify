...
export class MealPlanDayService {
  public resourceUrl = SERVER_API_URL + 'services/mealplans/api/meal-plan-days';
  public resourceSearchUrl = SERVER_API_URL + 'services/mealplans/api/_search/meal-plan-days';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IMealPlanDay[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
