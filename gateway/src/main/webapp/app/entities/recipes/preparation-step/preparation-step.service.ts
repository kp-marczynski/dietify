...
export class PreparationStepService {
  public resourceUrl = SERVER_API_URL + 'services/recipes/api/preparation-steps';
  public resourceSearchUrl = SERVER_API_URL + 'services/recipes/api/_search/preparation-steps';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IPreparationStep[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
