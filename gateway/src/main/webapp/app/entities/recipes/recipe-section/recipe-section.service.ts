...
export class RecipeSectionService {
  public resourceUrl = SERVER_API_URL + 'services/recipes/api/recipe-sections';
  public resourceSearchUrl = SERVER_API_URL + 'services/recipes/api/_search/recipe-sections';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IRecipeSection[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
