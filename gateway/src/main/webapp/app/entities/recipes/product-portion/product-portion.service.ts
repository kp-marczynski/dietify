...
export class ProductPortionService {
  public resourceUrl = SERVER_API_URL + 'services/recipes/api/product-portions';
  public resourceSearchUrl = SERVER_API_URL + 'services/recipes/api/_search/product-portions';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<IProductPortion[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
  }
}
