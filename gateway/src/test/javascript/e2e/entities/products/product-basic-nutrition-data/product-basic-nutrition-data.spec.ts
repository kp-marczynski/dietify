...
describe('ProductBasicNutritionData e2e test', () => {
  ...
  it('should create and save ProductBasicNutritionData', async () => {
    ...
    expect(await productBasicNutritionDataComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last ProductBasicNutritionData', async () => {
    ...
    expect(await productBasicNutritionDataDeleteDialog.getDialogTitle()).to.eq(
      'gatewayApp.productsProductBasicNutritionData.delete.question'
    );
