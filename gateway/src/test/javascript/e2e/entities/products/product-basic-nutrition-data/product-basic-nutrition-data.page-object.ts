...
export class ProductBasicNutritionDataComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-product-basic-nutrition-data div table .btn-danger'));
  title = element.all(by.css('jhi-product-basic-nutrition-data div h2#page-heading span')).first();
...
export class ProductBasicNutritionDataUpdatePage {
  pageTitle = element(by.id('jhi-product-basic-nutrition-data-heading'));
...
export class ProductBasicNutritionDataDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-productBasicNutritionData-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-productBasicNutritionData'));
