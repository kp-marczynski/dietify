...
import { MealPlanComponent } from 'app/entities/mealplans/meal-plan/meal-plan.component';
...
describe('Component Tests', () => {
  describe('MealPlan Management Component', () => {
    let comp: MealPlanComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MealPlanComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mealPlans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
