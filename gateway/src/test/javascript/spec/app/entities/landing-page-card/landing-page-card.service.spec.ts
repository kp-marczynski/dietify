...
describe('Service Tests', () => {
  describe('LandingPageCard Service', () => {
    let injector: TestBed;
    let service: LandingPageCardService;
    let httpMock: HttpTestingController;
    let elemDefault: ILandingPageCard;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a LandingPageCard', async () => {
        ...
        service
          .create(new LandingPageCard(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a LandingPageCard', async () => {
        const returnedFromService = Object.assign(
          {
            ordinalNumber: 1,
            htmlContent: 'BBBBBB'
      ...
      it('should return a list of LandingPageCard', async () => {
        const returnedFromService = Object.assign(
          {
            ordinalNumber: 1,
            htmlContent: 'BBBBBB'
      ...
      it('should delete a LandingPageCard', async () => {
