package pl.marczynski.dietify.mealplans.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("mealplans");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("mealplans");
        ...
        config.getMapConfigs().put("pl.marczynski.dietify.mealplans.domain.*", initializeDomainMapConfig(jHipsterProperties));
