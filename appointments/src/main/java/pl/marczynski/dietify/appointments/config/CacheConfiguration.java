package pl.marczynski.dietify.appointments.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("appointments");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("appointments");
        ...
        config.getMapConfigs().put("pl.marczynski.dietify.appointments.domain.*", initializeDomainMapConfig(jHipsterProperties));
