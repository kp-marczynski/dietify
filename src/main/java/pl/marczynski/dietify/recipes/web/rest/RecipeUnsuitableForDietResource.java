...
/**
 * REST controller for managing RecipeUnsuitableForDiet.
 */
@RestController
@RequestMapping("/api")
public class RecipeUnsuitableForDietResource {
    ...
    private static final String ENTITY_NAME = "recipeUnsuitableForDiet";
    ...
    /**
     * POST  /recipe-unsuitable-for-diets : Create a new recipeUnsuitableForDiet.
     *
     * @param recipeUnsuitableForDiet the recipeUnsuitableForDiet to create
     * @return the ResponseEntity with status 201 (Created) and with body the new recipeUnsuitableForDiet, or with status 400 (Bad Request) if the recipeUnsuitableForDiet has already an ID
    ...
    /**
     * PUT  /recipe-unsuitable-for-diets : Updates an existing recipeUnsuitableForDiet.
     *
     * @param recipeUnsuitableForDiet the recipeUnsuitableForDiet to update
     * @return the ResponseEntity with status 200 (OK) and with body the updated recipeUnsuitableForDiet,
     * or with status 400 (Bad Request) if the recipeUnsuitableForDiet is not valid,
     * or with status 500 (Internal Server Error) if the recipeUnsuitableForDiet couldn't be updated
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    ...
    public ResponseEntity<RecipeUnsuitableForDiet> updateRecipeUnsuitableForDiet(@Valid @RequestBody RecipeUnsuitableForDiet recipeUnsuitableForDiet) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, recipeUnsuitableForDiet.getId().toString()))
            .body(result);
    }

    /**
     * GET  /recipe-unsuitable-for-diets : get all the recipeUnsuitableForDiets.
     *
     * @return the ResponseEntity with status 200 (OK) and the list of recipeUnsuitableForDiets in body
     */
    ...
    /**
     * GET  /recipe-unsuitable-for-diets/:id : get the "id" recipeUnsuitableForDiet.
     *
     * @param id the id of the recipeUnsuitableForDiet to retrieve
     * @return the ResponseEntity with status 200 (OK) and with body the recipeUnsuitableForDiet, or with status 404 (Not Found)
     */
    ...
    /**
     * DELETE  /recipe-unsuitable-for-diets/:id : delete the "id" recipeUnsuitableForDiet.
     *
