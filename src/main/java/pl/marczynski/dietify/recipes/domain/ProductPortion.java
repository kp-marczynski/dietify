...
public class ProductPortion implements Serializable {
    ...
    public ProductPortion amount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public ProductPortion productId(Long productId) {
    ...
    public ProductPortion householdMeasureId(Long householdMeasureId) {
    ...
    public boolean equals(Object o) {
        ...
        if (productPortion.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), productPortion.getId());
    }
