...
import pl.marczynski.dietify.core.domain.ProductCategory;
import pl.marczynski.dietify.core.repository.ProductCategoryRepository;
import pl.marczynski.dietify.core.service.ProductCategoryService;
...
public class ProductCategoryResourceIntTest {
    ...
    public void createProductCategory() throws Exception {
        ...
        assertThat(testProductCategory.getDescriptionPolish()).isEqualTo(DEFAULT_DESCRIPTION_POLISH);
        assertThat(testProductCategory.getDescriptionEnglish()).isEqualTo(DEFAULT_DESCRIPTION_ENGLISH);
    }
    ...
    public void checkDescriptionPolishIsRequired() throws Exception {
        ...
        // set the field null
        productCategory.setDescriptionPolish(null);
    ...
    public void checkDescriptionEnglishIsRequired() throws Exception {
        int databaseSizeBeforeTest = productCategoryRepository.findAll().size();
        // set the field null
        productCategory.setDescriptionEnglish(null);
    ...
    public void updateProductCategory() throws Exception {
        ...
        ProductCategory testProductCategory = productCategoryList.get(productCategoryList.size() - 1);
        assertThat(testProductCategory.getDescriptionPolish()).isEqualTo(UPDATED_DESCRIPTION_POLISH);
        assertThat(testProductCategory.getDescriptionEnglish()).isEqualTo(UPDATED_DESCRIPTION_ENGLISH);
    }
