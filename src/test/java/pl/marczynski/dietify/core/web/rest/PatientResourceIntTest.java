...
public class PatientResourceIntTest {
    ...
    private static final Long DEFAULT_PREFERABLE_LANGUAGE_ID = 1L;
    private static final Long UPDATED_PREFERABLE_LANGUAGE_ID = 2L;
    ...
    public static Patient createEntity(EntityManager em) {
        Patient patient = new Patient()
            ...
            .preferableLanguageId(DEFAULT_PREFERABLE_LANGUAGE_ID);
        return patient;
    }
    ...
    public void createPatient() throws Exception {
        ...
        assertThat(testPatient.getPreferableLanguageId()).isEqualTo(DEFAULT_PREFERABLE_LANGUAGE_ID);
    }
    ...
    @Test
    @Transactional
    public void checkPreferableLanguageIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = patientRepository.findAll().size();
        // set the field null
        patient.setPreferableLanguageId(null);
    ...
    public void getAllPatients() throws Exception {
        ...
        restPatientMockMvc.perform(get("/api/patients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].preferableLanguageId").value(hasItem(DEFAULT_PREFERABLE_LANGUAGE_ID.intValue())));
    }
    ...
    public void getPatient() throws Exception {
        ...
        restPatientMockMvc.perform(get("/api/patients/{id}", patient.getId()))
            ...
            .andExpect(jsonPath("$.preferableLanguageId").value(DEFAULT_PREFERABLE_LANGUAGE_ID.intValue()));
    }
    ...
    public void updatePatient() throws Exception {
        ...
        updatedPatient
            ...
            .preferableLanguageId(UPDATED_PREFERABLE_LANGUAGE_ID);
        ...
        assertThat(testPatient.getPreferableLanguageId()).isEqualTo(UPDATED_PREFERABLE_LANGUAGE_ID);
    }
